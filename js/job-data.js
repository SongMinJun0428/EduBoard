...
const QUESTIONS = [
    // 1. 가치관 탐색
    {
        ...
        optionA: "연봉 높은 직업", descA: "경제적 보상과 성과를 중시함", tagsA: ["보상", "경제", "현실"],
        optionB: "행복한 직업", descB: "개인의 즐거움과 만족을 중시함", tagsB: ["행복", "만족", "삶의질"],
    ...
    },
    {
        ...
        title: "어떤 보상을 더 원하나요?",
        optionA: "명확한 금전적 보상", descA: "가시적인 보상과 효율을 중시", tagsA: ["보상", "경제", "현실"],
        optionB: "사회적 기여와 보람", descB: "타인에게 선한 영향력을 끼침", tagsB: ["의미", "보람", "사회가치"],
    ...
    // 2. 일하는 방식 탐색
    {
        ...
        optionA: "혼자 집중하는 직업", descA: "독립적으로 몰입할 수 있는 환경", tagsA: ["독립", "개인", "집중"],
        optionB: "팀으로 협력하는 직업", descB: "함께 아이디어를 나누는 환경", tagsB: ["협업", "소통", "팀워크"],
    ...
    // 3. 적성 탐색
    {
        ...
        optionA: "앞에 나가서 발표하기", descA: "자신감 있게 의견을 표현함", tagsA: ["표현", "소통", "리더십"],
        optionB: "뒤에서 자료 찾고 글 쓰기", descB: "내실 있게 분석하고 지원함", tagsB: ["기획", "분석", "지원"],
    ...
    },
    {
        ...
        optionA: "공감하고 위로/가르쳐주기", descA: "사람의 마음을 읽고 보듬어줌", tagsA: ["사람", "교육", "공감"],
        optionB: "상황을 분석하고 해결책 제시", descB: "냉철하게 원인을 찾고 해결함", tagsB: ["해결", "기술", "이성"],
        followUp: ["마음을 다루는 일이 편한가요, 사실과 데이터를 다루는 일이 편한가요?"]
    },
    {
        id: "a4", category: "aptitude",
        title: "둘 중 하나만 선택해야 한다면?",
        optionA: "사람들과 상호작용하는 일", descA: "대화와 소통이 중심인 활동", tagsA: ["사람", "소통", "관계"],
        optionB: "자료, 기술을 다루는 일", descB: "사물이나 기술 시스템의 전문화", tagsB: ["기술", "데이터", "집중"],
    ...
    },
    {
        ...
        title: "조직 내에서 나의 위치는?",
        optionA: "책임을 지고 이끄는 리더", descA: "강한 영향력과 리더십 발휘", tagsA: ["리더", "책임", "영향력"],
        optionB: "책임은 적지만 자유로운 팀원", descB: "개인의 독립성과 수평적 관계", tagsB: ["자유", "평등", "독립"],
